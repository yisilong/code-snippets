...
{   
  ...
  {   
    ...
    for (int i=0; i<npacketsize &&="" bsuccess;="" i++)="" bsuccess="(pReplyData[i]" =="E" );="" if="" (!bsuccess)="" setlasterror(error_unexp_net_err);="" }="" close="" the="" icmp="" handle="" sm_picmpclosehandle(hip);="" (bsuccess)="" {="" ping="" was="" successful,="" copy="" over="" pertinent="" info="" into="" return="" structure="" pr.address.s_un.s_addr="pEchoReply-">Address;   
