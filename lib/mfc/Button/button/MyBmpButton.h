...
#if !defined(AFX_MYBMPBUTTON_H__D6CCC57A_D357_41DA_ADC7_551F0726B3E8__INCLUDED_)
#define AFX_MYBMPBUTTON_H__D6CCC57A_D357_41DA_ADC7_551F0726B3E8__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000

#define	BMPBTN_USE_SOUND

#define BMPBTN_COLOR_FG_NORMAL	0
#define BMPBTN_COLOR_FG_CLICK	1
#define BMPBTN_COLOR_FG_HIGH		2

#define BMPBTN_ALIGN_LEFT			0
#define BMPBTN_ALIGN_RIGHT			1
#define BMPBTN_ALIGN_CENTER			2

/////////////////////////////////////////////////////////////////////////////
// CMyBmpButton window

class CMyBmpButton : public CButton
{
// Construction
public:
...
//					0. BMPBTN_ALIGN_LEFT
//					1. BMPBTN_ALIGN_RIGHT
//					2. BMPBTN_ALIGN_CENTER
//
//	BOOL bRepaint	- 是否立刻重画
//-------------------------------------------------------------------
	BOOL SetTextAlign(BYTE byAlign, BOOL bRepaint = TRUE);
...
//-------------------------------------------------------------------
//  函数：设置是否显示按钮文字
//	virtual CMyBmpButton& SetDrawText(BOOL bDraw = TRUE, BOOL bRepaint = TRUE);
//  参数：
//	BOOL bDraw  - 显示 ?
//	BOOL bRepaint	- 是否立刻重画
//-------------------------------------------------------------------
...
//-------------------------------------------------------------------
//  函数：设置字体是否为粗体
//	virtual CMyBmpButton& SetFontBold(BOOL bBold, BOOL bRepaint = TRUE);
//  参数：
//	BOOL bBold		- 粗体 ?
//	BOOL bRepaint	- 是否立刻重画
//-------------------------------------------------------------------
...
//-------------------------------------------------------------------
//  函数：设置字体名称
//	virtual CMyBmpButton& SetFontName(const CString& strFont, BYTE byCharSet = DEFAULT_CHARSET, BOOL bRepaint = TRUE);
//  参数：
...
//-------------------------------------------------------------------
//  函数：设置字体下划线
//	virtual CMyBmpButton& SetFontUnderline(BOOL bSet, BOOL bRepaint = TRUE);
//  参数：
//	BOOL bSet		- 下划线 ?
//	BOOL bRepaint	- 是否立刻重画
//-------------------------------------------------------------------
...
//-------------------------------------------------------------------
//  函数：设置字体 斜体
//	virtual CMyBmpButton& SetFontItalic(BOOL bSet, BOOL bRepaint = TRUE);
//  参数：
//	BOOL bSet		- 斜体 ?
//	BOOL bRepaint	- 是否立刻重画
//-------------------------------------------------------------------
...
//-------------------------------------------------------------------
//  函数：设置字体 字号
//	virtual CMyBmpButton& SetFontSize(int nSize, BOOL bRepaint = TRUE);
//  参数：
//	int nSize		- 字号
//	BOOL bRepaint	- 是否立刻重画
//-------------------------------------------------------------------
...
//-------------------------------------------------------------------
//  函数：设置字体
//	virtual CMyBmpButton& SetFont(LOGFONT lf, BOOL bRepaint = TRUE);
//  参数：
//	LOGFONT lf		- 字体
//	BOOL bRepaint	- 是否立刻重画
//-------------------------------------------------------------------
...
//-------------------------------------------------------------------
//  函数：设置 3d 字体 
//	virtual CMyBmpButton& SetFont3D(BOOL bSet, int i3dx = 3, int i3dy = 2, BOOL bRepaint = TRUE);
//  参数：
//	BOOL bSet		- 3d ?
//	int i3dx		- 阴影的距离 x
//	int i3dy		- 阴影的距离 y
...
//-------------------------------------------------------------------
//  函数：设置 3d 字体 阴影色彩
//	virtual CMyBmpButton& SetText3DBKColor(COLORREF cr3DBKColor, BOOL bRepaint = TRUE);
//  参数：
//	COLORREF cr3DBKColor - 阴影色彩
//	BOOL bRepaint		 - 是否立刻重画
//-------------------------------------------------------------------
	virtual CMyBmpButton& SetText3DBKColor(COLORREF cr3DBKColor, BOOL bRepaint = TRUE);	//Sets the 3D font hilite color

//-------------------------------------------------------------------
//  函数：设置 失效文字显示方式
//	virtual CMyBmpButton&  CMyBmpButton::SetDrawTextAsDisable(BOOL bSet, BOOL bRepaint = TRUE);
//  参数：
...
// Implementation
public:
	virtual ~CMyBmpButton();

	// Generated message map functions
protected:
	//{{AFX_MSG(CMyBmpButton)
...
#endif // !defined(AFX_MYBMPBUTTON_H__D6CCC57A_D357_41DA_ADC7_551F0726B3E8__INCLUDED_)
