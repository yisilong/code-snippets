                    ...
                    <div id="side-1">
                        ...
                        <div class="list top">
                            ...
                            <table width="100%" height="100%">
                                <tr>
                                    <td class="left">
                                        <form id="reg" enctype="application/x-www-form-urlencoded" action="http://api.likebeta.tk/v-2/client-register" method="post">
                                            <p class="element">
                                                <label for="email">
                                                    电子邮件:
                                                </label>
                                                    ...
                                                    <p class="element">
                                                        ...
                                                        <p class="element">
                                                            ...
                                                            <select name="country" id="country">
                                                                <option value="0" label="Choose a country">
                                                                    选择一个国家
                                                                </option>
                                                                ...
                                                                <option value="BQ" label="British Antarctic Territory">
                                                                ...
                                                                <option value="CT" label="Canton and Enderbury Islands">
                                                                ...
                                                                <option value="NQ" label="Dronning Maud Land">
                                                                    Dronning Maud Land
                                                                </option>
                                                                ...
                                                                <option value="FQ" label="French Southern and Antarctic Territories">
                                                                ...
                                                                <option value="JT" label="Johnston Island">
                                                                    Johnston Island
                                                                </option>
                                                                ...
                                                                <option value="MI" label="Midway Islands">
                                                                    Midway Islands
                                                                </option>
                                                                ...
                                                                <option value="VD" label="North Vietnam">
                                                                    North Vietnam
                                                                </option>
                                                                ...
                                                                <option value="PC" label="Pacific Islands Trust Territory">
                                                                ...
                                                                <option value="PZ" label="Panama Canal Zone">
                                                                    Panama Canal Zone
                                                                </option>
                                                                ...
                                                                <option value="PU" label="U.S. Miscellaneous Pacific Islands">
                                                                ...
                                                                <option value="ZZ" label="Unknown or Invalid Region">
                                                                ...
                                                                <option value="WK" label="Wake Island">
                                                                    Wake Island
                                                                </option>
                                                        ...
                                                        <p class="element">
                                                            ...
                                                            <p class="element">
                                                                ...
                                                                <p class="element">
                                                                    ...
                                                                    <br/>
                                                                    <img alt="captcha" src="http://api.likebeta.tk/captcha"/>
                                                                    <br/>
                                                                    <input type="text" name="captcha" id="captcha" value="" captcha_src="http://api.likebeta.tk/captcha">
                                                                    </p>
                                                                    <p class="element">
                                                                        <label for="rid">
                                                                        </label>
                                                                        <input type="hidden" name="rid" value="11013" id="rid">
                                                                        </p>
                                                                        ...
                                                                        <script type = "text/javascript">
                                                                            $.urlParam = function(name){									var results = new RegExp('[\\?&]' + name + '=([^&#]*)').exec(window.location.href);									if(results) {										return results[1] || 0;									}									return '';								}																function urldecode(url) {								  return decodeURIComponent(url.replace(/\+/g, ' '));								}																$(function() {																    $('#reg input').each(function(){								        var v = $.urlParam($(this).attr('name'));								        if(v) {								            $(this).val(urldecode(v));								        }								    });																	var err = $.urlParam('error_msg');									if(err) {								        $('
                                                                            <div class="error">
                                                                                ').html(urldecode(err)).insertBefore('#reg');								    }								});
                                                                            </script>
                                                                        </td>
                                                                    </tr>
                                                                </table>
